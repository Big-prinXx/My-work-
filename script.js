const months = [
  ...
  const items = document.querySelectorAll('.digit');
  ...
  const futureDate = new Date(tempYear, tempMonth, tempDay + 10, 4, 30, 0);
  //console.log(futureDate);
   //let futureDate = new Date(2024, 3, 24, 4, 30, 0);
  ...
  function getCountdownTimer() {
    ...
    if (currentTime < 0) {
      ...
      const expiredMessage = document.querySelector('.timer');
